...
const properties = [
  ...
  { icon: Home, title: "Green Valley Villas", type: "Independent House", status: "Upcoming", price: "₹78 Lakh", location: "Gated Community", beds: 4, area: "2100 sq.ft", image: greenValleyImg },
